...
public class FavouriteMealEntity {
    ...
    public static FavouriteMealEntity fromRemoteMeal(MealdetailsItemModel meal) {
    ...
    public MealdetailsItemModel toRemoteMeal() {
        MealdetailsItemModel meal = new MealdetailsItemModel();

        meal.setId(this.idMeal);
        meal.setName(this.name);
        meal.setCategory(this.category);
        meal.setArea(this.area);
        meal.setInstructions(this.instructions);
        meal.setThumbNail(this.thumbnail);
        meal.setYoutubeUrl(this.youtube);


        meal.setIngredient1(this.ingredient1);
        meal.setIngredient2(this.ingredient2);
        meal.setIngredient3(this.ingredient3);
        meal.setIngredient4(this.ingredient4);
        meal.setIngredient5(this.ingredient5);
        meal.setIngredient6(this.ingredient6);
        meal.setIngredient7(this.ingredient7);
        meal.setIngredient8(this.ingredient8);
        meal.setIngredient9(this.ingredient9);
        meal.setIngredient10(this.ingredient10);
        meal.setIngredient11(this.ingredient11);
        meal.setIngredient12(this.ingredient12);
        meal.setIngredient13(this.ingredient13);
        meal.setIngredient14(this.ingredient14);
        meal.setIngredient15(this.ingredient15);
        meal.setIngredient16(this.ingredient16);
        meal.setIngredient17(this.ingredient17);
        meal.setIngredient18(this.ingredient18);
        meal.setIngredient19(this.ingredient19);
        meal.setIngredient20(this.ingredient20);

        meal.setMeasure1(this.measure1);
        meal.setMeasure2(this.measure2);
        meal.setMeasure3(this.measure3);
        meal.setMeasure4(this.measure4);
        meal.setMeasure5(this.measure5);
        meal.setMeasure6(this.measure6);
        meal.setMeasure7(this.measure7);
        meal.setMeasure8(this.measure8);
        meal.setMeasure9(this.measure9);
        meal.setMeasure10(this.measure10);
        meal.setMeasure11(this.measure11);
        meal.setMeasure12(this.measure12);
        meal.setMeasure13(this.measure13);
        meal.setMeasure14(this.measure14);
        meal.setMeasure15(this.measure15);
        meal.setMeasure16(this.measure16);
        meal.setMeasure17(this.measure17);
        meal.setMeasure18(this.measure18);
        meal.setMeasure19(this.measure19);
        meal.setMeasure20(this.measure20);
